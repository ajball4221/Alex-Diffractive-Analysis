...
PLOTS_TO_MAKE = [
    {"name":"Inline Upstream vs t",
     "plot_type":"migration"},
    #{"name":"Inline Upstream Energy vs t",
    # "plot_type":"migration"},
    ...
    #{"name":"Lepton Energy",
    #  "plot_type":"comp"},
    {"name":"PiZero E Diffractive",
      "plot_type":"err"},
    {"name":"tDef1 Diffractive",
      "plot_type":"err"},
  ...
  # {"name":"Neutrino Energy",
    ...
    #{"variables":["Visible Energy","Lepton Pt"],
    # "plot_type":"stacked",
    # "args":(Categories,("bkg_tune",0)),
    # "tag":"bkg_tune1"},
    #{"variables":["Visible Energy","Lepton Pt"],
    # "plot_type":"stacked",
    # "args":(Categories,("bkg_tune",1)),
    # "tag":"bkg_tune2"},
    ...
    #{"name":"Front dEdX",
    #  "sideband_group": ("All",("Excess_High_Inline","Excess_Low_Inline","Pi0","Signal")),
    # },
    #{"variables":["PsiEe"],
    #  "sideband_group": ("Sidebands",("Excess_High_Inline","Excess_Low_Inline","Pi0")),
    # },
