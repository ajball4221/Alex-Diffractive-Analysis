...
from tools.AlexWeights import GetAlexWeights
...
class CVUniverse(ROOT.PythonMinervaUniverse, object):
    ...
    #def GetModelWeight(self):
        ...
        #print("Let's make this much more obvious",w)
        #return w'''
...
def GetAllSystematicsUniverses(chain,is_data,is_pc =False,is_dfr = False,exclude=None,playlist=None):
    ...
    if is_data:
        ...
        # Start commented section for systematics
    ...
    # End commented section for systematics
