...
t_fitted_err.SetMaximum(max([t_matrix_xsec.GetMaximum(),t_fitted_xsec.GetMaximum()])*1.2)
t_fitted_err.SetMinimum(min([t_matrix_xsec.GetMinimum(),t_fitted_xsec.GetMinimum()])/1.3)
t_fitted_err.GetXaxis().SetTitle("|t| (GeV/c)^{2}")
t_fitted_err.GetXaxis().SetTitleFont(62)
t_fitted_err.GetXaxis().SetTitleSize(0.045)
t_fitted_err.GetYaxis().SetTitle("Data/Simulation Cross Section Ratio")
...
t_canvas.Print("datafolder/xsecplots/t_xsecratio.png","png")
...
pion_recovered_err.GetYaxis().SetTitle("Data/Simulation Cross Section Ratio")
...
pion_legend = ROOT.gPad.BuildLegend(0.2,0.2,0.45,0.35)
pion_legend.SetTextFont(62)
pion_legend.SetTextSize(0.035)
pion_canvas.Print("datafolder/xsecplots/pion_xsecratio.png","png")
