...
print(mainweights,univweights)

def GetAlexWeights(event):
    if event.ShortName() != "cv": print(event.ShortName(),event.ithInWrapper)
    else: print("cv")
    ...
    #weights = np.loadtxt("/minerva/app/users/ajball/ncdiff/CC-NuE-XSec/tools/weights.txt",delimiter = ",")
    weights = np.array([[ 1.749526, 1.203664, 0.972739, 2.550476],
...
# weights = np.array([[ 1.74953,  1.20366,  0.97274,  2.55048],
# [ 1.9047,   1.24438,  0.67583,  4.35376],
# [ 1.95485,  1.24971,  1.16267,  2.79447],
# [ 2.21878,  1.1997,   0.94172,  4.34705],
# [ 2.56728,  1.0127,   1.33752,  3.83539],
# [ 2.15668,  1.25878,  1.14458,  5.50413],
# [ 2.6925,   1.17864,  1.01037,  6.08424],
# [ 4.03196,  1.09033,  5.18555,  3.11533],
# [ 4.00156,  1.20986,  7.7669,   7.34238],
# [-0.20444,  1.61974,  0.17042, -2.10573],
# [-0.94945,  1.26964,  2.2427,   9.21824]])
...
'''weights = np.array([[ 1.749526, 1.203664, 0.972739, 2.550476],
 ...
 [ 2.156684, 1.258782, 1.144583, 5.504132],
 [ 2.692498, 1.178637, 1.010366, 6.084236],
 [ 4.055675, 1.107161, 3.17452 , 4.506488],
 [ 3.43979 , 1.268706, 1.96393 , 8.841491],
 [-0.260964, 1.630252,-0.952191,-1.140646],
 [-0.965291, 1.281124, 2.499769, 0.073554]])'''
